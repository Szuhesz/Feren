...
The path to unlocking such power is often taxing. Those not born with it typically Awaken their magic through moments of intense emotion, where it surges forth involuntarily. This first manifestation is volatile, unpredictable—sometimes destructive. Yet once the barrier is broken, wielding it becomes easier, as if the soul remembers what it was always meant to grasp.
...
As stated, the arcane is rooted in divinity, but it is never freely given—it must be taken. A wielder's lifeforce serves as the most common fuel across Feren, a sacrifice of self to grasp the power of creation. Yet magic is not bound to a single source, all things hold energy, and for those willing to seek them, alternative reservoirs exist. However, the means by which they are drawn—and the morality of their use—remain subjects of debate, for not all sources are equal, nor are all paths righteous.